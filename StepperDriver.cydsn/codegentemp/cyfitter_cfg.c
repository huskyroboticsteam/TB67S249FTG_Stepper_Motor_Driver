...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDB_INT_CLK_CTL, 0x01u);
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F3626u, /* Base address: 0x400F3600 Count: 38 */
			0x400F371Fu, /* Base address: 0x400F3700 Count: 31 */
			...
			0x400F4709u, /* Base address: 0x400F4700 Count: 9 */
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x00300000u);

		/* UDB_PA_1 Starting address: CYDEV_UDB_PA1_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA1_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x70000000u);
