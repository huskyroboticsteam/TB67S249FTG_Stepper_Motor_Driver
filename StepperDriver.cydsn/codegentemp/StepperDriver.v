...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=4294967295, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=4294967294, InterruptOnCapture=false, InterruptOnCompare=true, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=4294967294, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=false, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Step_Counter, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Step_Counter, CY_INSTANCE_SHORT_NAME=Step_Counter, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Step_Counter, )
...
module top ;
	...
	wire [0:0] tmpOE__Step_Pin_net;
	wire [0:0] tmpFB_0__Step_Pin_net;
	wire [0:0] tmpIO_0__Step_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Step_Pin_net;
	electrical [0:0] tmpSIOVREF__Step_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Step_Pin
		 (.oe(tmpOE__Step_Pin_net),
		  .y({Net_998}),
		  .fb({tmpFB_0__Step_Pin_net[0:0]}),
		  .io({tmpIO_0__Step_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Step_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Step_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Step_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Counter_v3_0_0 Step_Counter (
        ...
        .up_ndown(Net_656),
        .upCnt(1'b0));
    defparam Step_Counter.CaptureMode = 0;
    defparam Step_Counter.ClockMode = 1;
    defparam Step_Counter.CompareMode = 0;
    defparam Step_Counter.CompareStatusEdgeSense = 1;
    defparam Step_Counter.EnableMode = 0;
    defparam Step_Counter.ReloadOnCapture = 0;
    defparam Step_Counter.ReloadOnCompare = 0;
    defparam Step_Counter.ReloadOnOverUnder = 0;
    defparam Step_Counter.ReloadOnReset = 1;
    defparam Step_Counter.Resolution = 32;
    defparam Step_Counter.RunMode = 0;
    defparam Step_Counter.UseInterrupt = 1;
    ...
    Debouncer_v1_0 Debouncer_Lim_1 (
        .clock(Net_622),
        .d(Net_633),
        .either(Net_637),
        .neg(Net_636),
        .pos(Net_638),
        .q(Net_635));
    defparam Debouncer_Lim_1.EitherEdgeDetect = 0;
    defparam Debouncer_Lim_1.NegEdgeDetect = 0;
    defparam Debouncer_Lim_1.PosEdgeDetect = 0;
    defparam Debouncer_Lim_1.SignalWidth = 1;
    ...
    Debouncer_v1_0 Debouncer_Lim_2 (
        .clock(Net_622),
        .d(Net_717),
        .either(Net_714),
        .neg(Net_715),
        .pos(Net_716),
        .q(Net_719));
    defparam Debouncer_Lim_2.EitherEdgeDetect = 0;
    defparam Debouncer_Lim_2.NegEdgeDetect = 0;
    defparam Debouncer_Lim_2.PosEdgeDetect = 0;
    defparam Debouncer_Lim_2.SignalWidth = 1;

    SCB_P4_v4_0_1 DBG_UART (
        .clock(1'b0),
        .cts_in(1'b0),
        .interrupt(Net_743),
        .m_miso(1'b0),
    ...
    defparam Step_Timer.CompareMode = 0;
    ...
    defparam Step_Timer.ReloadOnReset = 1;
    defparam Step_Timer.Resolution = 24;
    defparam Step_Timer.RunMode = 0;
    defparam Step_Timer.UseInterrupt = 1;
